...
function Datepicker() {
	...
	this.dpDiv = datepicker_bindHover( $( "<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content-picker ui-helper-clearfix ui-corner-all'></div>" ) );
}
...
$.extend( Datepicker.prototype, {
	...
	_newInst: function( target, inline ) {
		...
		return { id: id, input: target, // associated target
			...
			datepicker_bindHover( $( "<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content-picker ui-helper-clearfix ui-corner-all'></div>" ) ) ) };
	},
...
$.widget( "ui.dialog", {
	...
	_create: function() {
		...
		this._addClass( "ui-dialog-content", "ui-widget-content-picker" );
